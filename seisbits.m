...
NumErrores=6;%inicialización de número de errores en 4 debido al corrimiento de 4 bits de la señal x1.

L1=x1(7:length(x1)); %concatenación del vector reconstruido y 0 0 0 para que el tamaño del vector sea múltiplo de 8 bits
